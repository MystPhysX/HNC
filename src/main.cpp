...
uint256 hashGenesisBlock("0xf442d452f66522b9732fb01ea52fe729299d13d05bbf45414fb41fddbd2ced76");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // helleniccoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "helleniccoin Signed Message:\n";
...
{
    // helleniccoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight == 1){
        nSubsidy = nSubsidy * 100000000 * 50  / 100 / 500;
     }
...
static const int64 nTargetTimespan = 259200;
static const int64 nTargetSpacing = 1800;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // helleniccoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // helleniccoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // helleniccoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf442d452f66522b9732fb01ea52fe729299d13d05bbf45414fb41fddbd2ced76");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1420660923;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086068093;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("helleniccoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("helleniccoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running helleniccoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("helleniccoinMiner terminated\n");
        throw;
    }
}
