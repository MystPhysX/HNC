...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click helleniccoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start helleniccoin: click-to-pay handler");
    else
...
{
    // clicking on helleniccoin: URLs creates FileOpen events on the Mac:
